 ...
 * @author Ivo Woltring
 */
public class SurnameCommaFirstInitialsStrategyTest {

    private SurnameCommaFirstInitialsStrategy strategy;

    @Before
    public void setUp() throws Exception {
        strategy = new SurnameCommaFirstInitialsStrategy();
    }
    ...
    public void testStragegy4() throws Exception {
        ...
        final String format = strategy.format(name);
        assertEquals("Woltring Jr., I.", format);
    }
