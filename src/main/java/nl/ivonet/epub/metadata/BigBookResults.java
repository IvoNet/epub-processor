 ...
 * }
 */
public class BigBookResults {

    private final List<BigBookImage> results;

    public BigBookResults(final List<BigBookImage> results) {
        this.results = new ArrayList<>(results);
    }

    public BigBookResults() {
        this.results = new ArrayList<>();
    }

    public List<BigBookImage> getResults() {
        return new ArrayList<>(results);
    }

    public void add(final BigBookImage image) {
        this.results.add(image);
    }

    @Override
    public String toString() {
        return "BigBookResults{" +
              "results=" + results +
              '}';
    }
}
